...
var ocean = new TimelineMax({repeat:4, yoyo:true});  
ocean.to(floating, 2, {
     y:10,
     ease:Power1.easeInOut,
     delay:0
});
// ocean.to(floating_text, 2, {
//      y:10,
//      ease:Power1.easeInOut,
//      delay:3
// });
...
var buoySway = new TimelineMax({repeat:9, yoyo:true});  
buoySway.to(buoy, 1.5, {
     rotation:15,
    // y:20,
