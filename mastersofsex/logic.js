...
function setupDom() {
  ...
  creative.canvas2Container = document.getElementById('canvas-container');
...
//-----------------------------------
  ...
  function onOutHandler() {
    if(creative.onEndframe == true){
      ...
      TweenMax.to(creative.canvas2Container, 0.8, { 
              opacity:0,
              ease:Power0.none
      });
 ...
 function onOverReplay() {
  ...
  function onReplayHandler(e) {
    ...
    creative.exit.removeEventListener('mouseenter', function(e){});
    creative.exit.removeEventListener('mousemove', function(e){});
...
//-----------------------------------
  ...
  var ddtObjectArray = [
    { // default leave date 1/1/2000 . Month is 1 num back. (august = 7)
      ...
      date_version:1
        ...
        date: new Date("9/5/2016"),
        mp4: path + filename + ".mp4",
        webm: path + filename + ".webm",
        date_version:2
    },{//tonight
        date: new Date("9/11/2016"),
        mp4: path + filename + ".mp4",
        webm: path + filename + ".webm",
        date_version:3
    },{//sunday
        date: new Date("9/12/2016"),
        mp4: path + filename + ".mp4",
        webm: path + filename + ".webm",
        date_version:2
    },{//tonight
        ...
        date: new Date("9/19/2016"),
        mp4: path + filename + ".mp4",
        webm: path + filename + ".webm",
        date_version:2
    },{//tonight
        date: new Date("9/25/2016"),
        mp4: path + filename + ".mp4",
        webm: path + filename + ".webm",
        date_version:3
    },{//sunday
  ...
  function set_tuneIns(){
    ...
    if(ddtObject.cta===2)
    {
        creative.cta_off.src="images/cta_off_np.png";
        creative.cta_on.src="images/cta_on_np.png";
    }
...
function draw(myImage,myAuto,myCanvas) {
        ...
        img.onload = function(){
            ...
            //     window.requestAnimationFrame(function(){kaleidoscope(w, h, img, myCanvas, ctx, triangles, mouseX*4, mouseY*1.3);});
            // });
            creative.exit.addEventListener('mouseenter', myfunction1);
            ...
            creative.exit.addEventListener('mousemove', myfunction2);
            ...
            if(myAuto){
                creative.exit.removeEventListener('mouseenter', myfunction1);
                creative.exit.removeEventListener('mousemove', myfunction2);
