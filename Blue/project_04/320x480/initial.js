...
/******************  MAIN ANIMATION  ******************/ 
		function animate() { 
            ...
            .from([pic_box],{duration:1.1,x:"-=320px", alpha:1,ease:"power4.out"}, "<0.3")
            .from([pic1],{duration:1.1,x:"-=320px", alpha:1,ease:"power4.out"}, "<0.1")
            .from([bar1],{duration:1.1,x:"-=30px", alpha:0, ease:"power4.out"}, "<0.4")
            .from([bar2],{duration:1.1,x:"-=30px", alpha:0, ease:"power4.out"}, "<0.1")
            .from([bar3],{duration:1.1,x:"-=30px", alpha:0, ease:"power4.out"}, "<0.1")
            //
            ...
            //
            .to(pic1, {duration:1.1, alpha:0,x:"-=40px", scale:1,ease:"power1.out"}, "<4.0")
            .from(pic2, {duration:0.8, alpha:0, x:"-=40px", scale:1,ease:"power1.out"}, "<0.5")
            //
            .to(pic2, {duration:1.1, alpha:0,x:"-=40px", scale:1,ease:"power1.out"}, "<4.0")
            .to(pic1, {duration:0.8, alpha:1, x:"+=40px", scale:1,ease:"power1.out"}, "<0.5")
