...
/******************  MAIN ANIMATION  ******************/ 
		function animate() { 
            tl
            // .set([bgexit], {alpha:0})
            .to(bannerCover, {duration:1, alpha:0, ease:"none"},">0.1")
            .staggerFrom(text1_arr, 0.5, {alpha: 0, scale:"0.65", ease:"back.out(4.2)"}, 0.1, "<0.2")
            .to(p1, {duration:0.6, alpha: 1,x:"-=320" ,ease:"power4.out"}, ">0.5")
            //// exit ////
            .from(text21, 0.5, {alpha: 0, scale:"0.65", ease:"back.out(4.2)"}, ">-0.3")
            .from(icon_fish, {duration:0.5,y:"-=550" ,ease:"back.out(1.7)"}, ">-0.0")
            .to(icon_fish, {duration:0.9,y:"-=10" }, ">0")
            .to(icon_fish, {duration:0.4,y:"-=550" ,ease:"back.in(1.7)"}, "<0.9")
            //// spam ////
            ...
            .staggerTo(mail_arr, 0.4, {alpha: 0, scale:"0", ease:"back.in(2.8)"}, 0.07, ">0.1")
            //// malware ////
            ...
            .to(p2, {duration:0.6, alpha: 1,x:"-=320" ,ease:"power4.out"}, ">0.4")
            .staggerFrom(text3_arr, 0.5, {alpha: 0, scale:"0.65", ease:"back.out(4.2)"}, 0.1, "<0.2")
            .from(cta, {duration:0.9, alpha: 0, scale:0.7,ease:"back.out(2.2)"}, "<0.4")
            .from(logo_barracuda, {duration:0.9, alpha: 0,ease:"none"}, "<0.1")
            .from(logo_blueAlly, {duration:0.9, alpha: 0,ease:"none"}, "<0.2")
