...
/******************  MAIN ANIMATION  ******************/ 
		function animate() { 
            ...
            .to(p1, {duration:0.6, alpha: 1,x:"-=728" ,ease:"power4.out"}, ">0.6")
            ...
            .staggerFrom(text23, 0.5, {alpha: 0, scale:"0.65", ease:"back.out(4.2)"}, 0.1, ">0")
             .from(bug_box1, 0.6, {rotate:"+=90", ease:"none"}, ">-0.2")
            .from(bug_box2, 0.6, {rotate:"+=90", ease:"none"}, "<0.15")
            .to(p2, {duration:0.6, alpha: 1,x:"-=728" ,ease:"power4.out"}, ">0.3")
            //Part 3
