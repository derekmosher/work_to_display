...
/******************  MAIN ANIMATION  ******************/ 
		function animate() { 
            ...
            .to(p1, {duration:0.6, alpha: 1,x:"-=320" ,ease:"power4.out"}, ">0.6")
            ...
            .staggerTo(mail_arr, 0.4, {alpha: 0, scale:"0", ease:"back.in(2.8)"}, 0.03, ">0.1")
            //// malware ////
            ...
            .to(p2, {duration:0.6, alpha: 1,x:"-=320" ,ease:"power4.out"}, ">0.3")
            //Part 3
