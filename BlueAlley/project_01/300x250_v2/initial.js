...
/******************  MAIN ANIMATION  ******************/ 
		function animate() { 
            tl
            // .set([bgexit], {alpha:0})
            .to(bannerCover, {duration:1, alpha:0, ease:"none"},">0.2")
        
            .staggerFrom(text1_arr, 0.5, {alpha: 0, scale:"0.65", ease:"back.out(4.2)"}, 0.1, "<0.7")

            .to(p1, {duration:0.6, alpha: 1,x:"-=300" ,ease:"power4.out"}, ">0.8")
            //// exit ////
            ...
            .from(bug_box2, 0.5, {rotate:"+=90", ease:"none"}, "<0.2")

            .to(p2, {duration:0.6, alpha: 1,x:"-=300" ,ease:"power4.out"}, ">0.4")

            .staggerFrom(text3_arr, 0.5, {alpha: 0, scale:"0.65", ease:"back.out(4.2)"}, 0.1, "<0.3")
            .from(cta, {duration:0.9, alpha: 0, scale:0.7,ease:"back.out(2.2)"}, "<0.4")
            .from(logo_barracuda, {duration:0.9, alpha: 0,ease:"none"}, "<0.1")
            .from(divider, {duration:0.9, alpha: 0,ease:"none"}, "<0.1")
            .from(logo_blueAlly, {duration:0.9, alpha: 0,ease:"none"}, "<0.1")
