...
/******************  MAIN ANIMATION  ******************/ 
		function animate() { 
            tl
            .to(bannerCover, {duration:0.6, alpha:0, ease:"none"},">0.0")
            .staggerFrom(text1_arr, 0.5, {alpha: 0, scale:"0.65", ease:"back.out(4.2)"}, 0.1, "<0.4")
            .to(p1, {duration:0.6, alpha: 1,x:"-=970" ,ease:"power4.out"}, ">0.4")
            ...
            .staggerTo(mail_arr, 0.4, {alpha: 0, scale:"0", ease:"back.in(2.8)"}, 0.03, ">0.0")
            //// malware ////
            .staggerFrom(text23, 0.5, {alpha: 0, scale:"0.65", ease:"back.out(4.2)"}, 0.1, ">0")
            .from(bug_box1, 0.6, {rotate:"+=120", ease:"none"}, ">0")
            .from(bug_box2, 0.6, {rotate:"+=120", ease:"none"}, "<0.1")
            .to(p2, {duration:0.6, alpha: 1,x:"-=970" ,ease:"power4.out"}, ">0.2")
            //Part 3
         
            .staggerFrom(text3_arr, 0.5, {alpha: 0, scale:"0.65", ease:"back.out(4.2)"}, 0.2, ">-0.3")

            .from(cta, {duration:0.9, alpha: 0, scale:0.7,ease:"back.out(2.2)"}, "<0.4")
            .from(logo_barracuda, {duration:0.9, alpha: 0,ease:"none"}, "<0.1")
            ...
            // .from(logo_barra_text1, {duration:1.1, alpha: 1, x:"+=350",ease:"power4.out"}, "<0")
            ...
            // .to(p1, {duration:0.6, alpha: 1,x:"-=970" ,ease:"power4.out"}, ">1.4")
            ...
            // .to(p2, {duration:0.6, alpha: 1,x:"-=970" ,ease:"power4.out"}, ">0.6")
            // //Part 3
         
            // .staggerFrom(text3_arr, 0.5, {alpha: 0, scale:"0.65", ease:"back.out(4.2)"}, 0.2, ">0.1")
            // .from(logo_barracuda, {duration:0.9, alpha: 0,ease:"none"}, "<0.6")
            // .from(divider, {duration:1.1, alpha: 0,ease:"power4.out"}, "<0.05")
            // .from(logo_blueAlly, {duration:1.1, alpha: 0,ease:"power4.out"}, "<0.05")
