...
/******************  MAIN ANIMATION  ******************/ 
		function animate() { 
            ...
            .to(p1, {duration:0.6, alpha: 1,x:"-=160" ,ease:"power4.out"}, ">1.5")
            //// exit ////
            ...
            .from(bug_box1, 0.65, {rotate:"+=90", ease:"none"}, ">0")
            .from(bug_box2, 0.65, {rotate:"+=90", ease:"none"}, "<0.1")

            .to(p2, {duration:0.6, alpha: 1,x:"-=160" ,ease:"power4.out"}, ">0.7")
