...
function goOver(){
    ...
    gsap.to([logo_cisco,divider,logo_blueAlly], {duration:0.6, 
        y:"-4px",
        ease:"power1.out"}  
    ) ;
    gsap.to([text_head], {duration:0.6, 
        y:"-8px",
        ease:"power1.out"}  
    ) ;
    gsap.to([text_sub], {duration:0.6, 
        y:"-10px",
        ease:"power1.out"}  
    ) ;
...
function goOut(){
    ...
    gsap.to([cta, logo_cisco,divider,logo_blueAlly,text_head,text_sub], {duration:0.3, 
        y:"0px",
        overwrite:true,
        ease:"power1.out"}  
    ) ;
