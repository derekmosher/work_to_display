...
/******************  MAIN ANIMATION  ******************/ 
		function animate() { 
            ...
            // Out P1
            .to(text11, 0.7, {alpha: 0, ease:"back.in(2.2)"}, ">1.2")
            ...
            // In P2
            .staggerFrom(idevices_arr, 0.9, {scale:"1",y:"200px", ease:"power4.out"}, 0.1, ">-0.2")
            .from(network1, 1.2, {clip: "rect(600px,300px,600px,0px)", ease:"power1.out"},"<0.2")
            .from(text21, 0.7, {alpha: 0, scale:"0.65", ease:"back.out(2.2)"}, "<0.2")
             // Out P2
            ...
            // .to([p2], 0.4, {alpha:0, ease:"power1.out"},">2.0")
