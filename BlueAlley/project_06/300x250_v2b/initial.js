...
/******************  MAIN ANIMATION  ******************/ 
		function animate() { 
            ...
            .from(teacher_arr, 0.7, {alpha: 1, scale:"1",x:"300px", ease:"power4.out"}, "<0.15")
            .from(text11, 0.7, {alpha: 0, scale:"0.65", ease:"back.out(2.2)"}, "<0.3")
            // Out P1
            .to(text11, 0.7, {alpha: 0, cale:"0.65", ease:"back.in(2.2)"}, ">1.2")
            .to(teacher_arr, 0.8, {alpha: 1, scale:"1",x:"-350px", ease:"power4.out"}, ">0.0")
            ...
            .from(network1, 0.6, {clip: "rect(300px,250px,250px,0px)", ease:"power1.out"},"<0.2")
            ...
            .to([idevices_arr,guy, network1,network2,wire], 1.2, {y:"250px", ease:"power4.out"},"<0.4")
            .from(text31, 0.7, {alpha: 0, scale:"0.65", ease:"back.out(2.2)"}, ">-0.7")

            // Out P3           
            .to([text31,guy,network2,wire], 0.4, {alpha:0, ease:"power1.out"},">1.8")
