...
/******************  MAIN ANIMATION  ******************/ 
		function animate() { 
            ...
            .from(network1, 0.7, {alpha: "0", ease:"power1.out"},"<0.4")
            .from(text21, 0.7, {alpha: "0", scale:"0.65", ease:"back.out(2.2)"}, "<0")
             
            // Out P2 + In P3
            .to(text21, 0.7, {alpha: "0", scale:"0.65", ease:"back.in(2.2)"}, ">1.6")
            .to([idevices_arr,network1], 0.9, {y:"158px",ease:"power4.out"}, "<0.5")
            .from(text31, 0.7, {alpha: 0, scale:"0.65", ease:"back.out(2.2)"}, ">-0.5")
            // Out P3
            .to([text31], 0.4, {alpha:0, ease:"power1.out"},">1.8")
            .to([p3,p2], 0.4, {alpha:0, ease:"power1.out"},"<0.4")
