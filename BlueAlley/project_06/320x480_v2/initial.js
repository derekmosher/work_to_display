...
/******************  MAIN ANIMATION  ******************/ 
		function animate() { 
            ...
            .to(teacher_arr, 0.8, {alpha: 1, scale:"1",x:"-490px", ease:"power4.out"}, ">0.0")
            ...
            .from(network1, 0.6, {clip: "rect(480px,320px,320px,0px)", ease:"power1.out"},"<0.2")
            ...
            .to([idevices_arr,guy, network1,network2,wire], 1.8, {y:"480px", ease:"power4.out"},"<0.4")
