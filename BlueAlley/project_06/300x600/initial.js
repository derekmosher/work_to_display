...
/******************  MAIN ANIMATION  ******************/ 
		function animate() { 
            ...
            .from(text11, 0.7, {alpha: 0, scale:"0.65", ease:"back.out(2.2)"}, "<0.4")
            // Out P1
            .to(text11, 0.7, {alpha: 0, ease:"back.in(2.2)"}, ">0.8")
            ...
            // In P2
            .staggerFrom(idevices_arr, 1.1, {scale:"1",y:"200px", ease:"power4.out"}, 0.1, ">-0.2")
            .from(network1, 1.2, {clip: "rect(600px,300px,300px,0px)", ease:"power1.out"},"<0.4")
            .from(text21, 0.7, {alpha: 0, scale:"0.65", ease:"back.out(2.2)"}, "<0.7")
             // Out P2
            .to([p2], 0.4, {alpha:0, ease:"power1.out"},">1.6")

            // In P3
            .from(guy, 0.7, {alpha: 0, scale:"0.65", ease:"back.out(2.2)"}, "<0.4")
            .from(network2, 0.7, {alpha: 0, scale:"0.25", ease:"back.out(2.2)"}, "<0.2")
            .from(text31, 0.7, {alpha: 0, scale:"0.65", ease:"back.out(2.2)"}, "<0.5")
            // Out P3
            .to([text31,guy,network2], 0.4, {alpha:0, ease:"power1.out"},">1.6")
            ...
            // .staggerTo(student_arr, 0.4, {alpha: 0, scale:"0", ease:"back.in(2.8)"}, 0.07, ">0.0")
            //// malware ////
            .staggerFrom(text23, 0.5, {alpha: 0, scale:"0.65", ease:"back.out(4.2)"}, 0.1, ">0")
            // .to(p2, {duration:0.6, alpha: 1,x:"-=300" ,ease:"power4.out"}, ">0.2")
            // part 3 //
            // .from(logo_cisco, {duration:0.9, alpha: 0,ease:"none"}, "<0.4")
