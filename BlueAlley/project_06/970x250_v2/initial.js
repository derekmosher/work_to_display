...
/******************  MAIN ANIMATION  ******************/ 
		function animate() { 
            ...
            .to(student_arr, 0.8, {alpha: 1, scale:"1",x:"230px", ease:"power3.out"},  "<0.5")
            ...
            .to([idevices_arr,guy, network1,network2,wire], 1.2, {y:"270px", ease:"power4.out"},"<0.5")
            ...
            .from(text42, 0.7, {alpha: 0, scale:"0.65", ease:"back.out(2.2)"}, "<0.2")
