...
/******************  MAIN ANIMATION  ******************/ 
		function animate() { 
            ...
            // .staggerFrom(student_arr, 1.0, {alpha: 1, scale:"1",x:"230px", ease:"power4.out"}, 0.1, ">0")
        ...
        //    .to([text31,guy,network2], 0.4, {alpha:0, ease:"power1.out"},">1.6")
            .to(text31, 0.7, {alpha: 0, scale:"0.65", ease:"back.in(2.2)"}, ">1.6")
            .to([p3], 0.4, {alpha:0, ease:"power1.out"},"<0.8")
